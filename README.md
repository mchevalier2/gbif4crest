...
This data engineering pipeline retrieves and organizes observations from the [GBIF database](https://www.gbif.org) into a structured relational database. This standardized database includes calibration data essential for implementing the CREST climate reconstruction method using fossil bioindicators, and is compatible with the [crestr R package](https://www.manuelchevalier.com/crestr/index.html). It integrates information from multiple sources, resulting in a simple SQL database illustrated below. For a comprehensive overview of the various tables, refer to [here](https://www.manuelchevalier.com/crestr/articles/calibration-data.html).
