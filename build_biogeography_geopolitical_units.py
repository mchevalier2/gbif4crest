""" Create the biogeography and geopolitical_units tables """
...
for c in countries:
    ...
    geopolitical_units.append(
        [int(c.numeric), continent_name, np.nan, c.name, official_name, country_code]
    )


geopolitical_units.append(
    [1000, "Europe", "Kosovo", "Republic of Kosovo", "XXK", np.nan]
)
geopolitical_units.append(
    [
        1001,
...
geopolitical_units.append(
    [1002, "Oceania", "Clipperton Island", "Clipperton Island", np.nan, np.nan]
)
geopolitical_units.append(
    [1003, "Asia", "Spratly Islands", "Spratly Islands", np.nan, np.nan]
)
geopolitical_units.append(
    [1004, "South America", "Saint Martin", "Saint Martin", np.nan, np.nan]
)
geopolitical_units.append(
    [
        1005,
...
for idx, row in count.iterrows():
    geopolitical_units.append(
        [row["ID"], np.nan, row["ocean"], row["country"], np.nan, np.nan]
    )


geopolitical_units = pd.DataFrame(
    geopolitical_units,
    columns=["geopoID", "continent", "basin", "name", "official_name", "countrycode"],
)


geopolitical_units.loc[
    geopolitical_units["name"] == "Bolivia, Plurinational State of", "name"
] = "Bolivia"
geopolitical_units.loc[
    geopolitical_units["name"] == "Micronesia, Federated States of", "name"
] = "Micronesia"
geopolitical_units.loc[
    geopolitical_units["name"] == "Iran, Islamic Republic of", "name"
] = "Iran"
geopolitical_units.loc[geopolitical_units["name"] == "Moldova, Republic of", "name"] = (
    "Moldova"
)
geopolitical_units.loc[geopolitical_units["name"] == "Palestine, State of", "name"] = (
    "Palestine"
)
geopolitical_units.loc[
    geopolitical_units["name"] == "Taiwan, Province of China", "name"
] = "Taiwan"
geopolitical_units.loc[
    geopolitical_units["name"] == "Tanzania, United Republic of", "name"
] = "Tanzania"
geopolitical_units.loc[
    geopolitical_units["name"] == "Venezuela, Bolivarian Republic of", "name"
] = "Venezuela"
geopolitical_units.loc[geopolitical_units["name"] == "North Macedonia", "name"] = (
    "Macedonia"
)
...
geopolitical_units.loc[
    geopolitical_units["name"] == "Russian Federation", ["name", "official_name"]
] = ["Russia", "Russian Federation"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Congo, The Democratic Republic of the",
    ["name", "official_name"],
] = ["DRC", "The Democratic Republic of the Congo"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Lao People s Democratic Republic",
    ["name", "official_name"],
] = ["Laos", "Lao People s Democratic Republic"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Korea, Democratic People s Republic of",
    ["name", "official_name"],
] = ["North Korea", "Democratic People s Republic of Korea"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Korea, Republic of", ["name", "official_name"]
] = ["South Korea", "Republic of Korea"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Syrian Arab Republic", ["name", "official_name"]
] = ["Syria", "RSyrian Arab Republic"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Saint Helena, Ascension and Tristan da Cunha",
    ["name", "official_name"],
] = ["Saint Helena", "Saint Helena, Ascension and Tristan da Cunha"]
geopolitical_units.loc[
    geopolitical_units["name"] == "Pitcairn", ["name", "official_name"]
] = ["Pitcairn Island", "Pitcairn Island"]


print(geopolitical_units)
geopolitical_units.to_csv(
    DATABASE_FOLDER + "geopolitical_units.csv", encoding="utf-8-sig", index=False
)
...
""" Accepted pylint errors *************
    231:0: C0301: Line too long (105/100) (line-too-long)
    107:8: C0103: Constant name "official_name" doesn't conform to UPPER_CASE naming style (invalid-name)
    229:0: W0105: String statement has no effect (pointless-string-statement)
"""
